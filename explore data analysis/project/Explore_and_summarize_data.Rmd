---
title: "Explore and summarize prosperLoanData"
author: Simon Shen
date: "01/21/2018"
output: 
  html_document:
...
```{r}
p1 = ggplot(data = prosper,aes(x = CurrentDelinquencies)) +
  geom_histogram() + 
  scale_x_log10()

p2 = ggplot(data = prosper,aes(x = "CurrentDelinquencies",y = CurrentDelinquencies)) +
  geom_boxplot() 
...
ggplot(data = subset(prosper,ProsperRating..Alpha. != ''),
       aes(x = ProsperRating..Alpha.,
           y = BorrowerRate)) +
  geom_point(alpha = 0.2, position = position_jitter(h = 0,width = 0.5),
             aes(color = Term))+
